...
const ChooseCategory = () => {
  ...
  console.log('la categoria: ', result)
        ...
        {!loading && result !== undefined && (
          result.map((category: CategoryType) => (
            ...
            >
              ...
              />
              <p className='absolute w-full oy-2 text-lg font-bold text-center text-white bottom-5 backdrop-blur-lg'>{category.attributes.categoryName}</p>
            </Link>
          ))
        )}
      </div>
